...
{url-base}#L87[`bomb`],
{url-base}#L93[`cheat`],
{url-base}#L105[`cmd_exists`],
{url-base}#L118[`die`],
{url-base}#L127[`echo`],
{url-base}#L146[`file_exists`],
{url-base}#L160[`grbt`],
{url-base}#L171[`heic2jpg`],
{url-base}#L185[`inside`],
{url-base}#L193[`isempty`],
{url-base}#L207[`isfunc`],
{url-base}#L215[`isreadable`],
{url-base}#L231[`issolid`],
{url-base}#L260[`iswritable`],
{url-base}#L285[`log`],
{url-base}#L294[`loge`],
{url-base}#L302[`logw`],
{url-base}#L311[`pdf2jpg`],
{url-base}#L320[`pdf2png`],
{url-base}#L343[`prettytable`],
{url-base}#L369[`prettyuptime`],
{url-base}#L392[`realdir`],
{url-base}#L401[`realpath`],
{url-base}#L413[`semver`],
{url-base}#L430[`timestamp`],
{url-base}#L450[`tolog`],
{url-base}#L456[`tologe`],
{url-base}#L462[`tolower`],
{url-base}#L467[`totsout`],
{url-base}#L473[`tsout`],
{url-base}#L481[`url_exists`],
{url-base}#L505[`user_exists`],
{url-base}#L521[`validate_cmd`],
{url-base}#L528[`validate_var`],
{url-base}#L535[`var_exists`],
{url-base}#L555[`ver_ge`],
{url-base}#L560[`vid2aud`],
{url-base}#L575[`yes_to_continue`],
{url-base}#L629[`ytda`].
