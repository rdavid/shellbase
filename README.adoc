...
{url-base}#L356[`loge`],
{url-base}#L364[`logw`],
{url-base}#L373[`pdf2jpg`],
{url-base}#L383[`pdf2png`],
{url-base}#L407[`prettytable`],
{url-base}#L433[`prettyuptime`],
{url-base}#L456[`realdir`],
{url-base}#L465[`realpath`],
{url-base}#L478[`semver`],
{url-base}#L494[`timestamp`],
{url-base}#L514[`tolog`],
{url-base}#L520[`tologe`],
{url-base}#L527[`tolower`],
{url-base}#L545[`totsout`],
{url-base}#L551[`tsout`],
{url-base}#L559[`url_exists`],
{url-base}#L583[`user_exists`],
{url-base}#L599[`validate_cmd`],
{url-base}#L606[`validate_var`],
{url-base}#L613[`var_exists`],
{url-base}#L635[`ver_ge`],
{url-base}#L643[`vid2aud`],
{url-base}#L659[`yes_to_continue`],
{url-base}#L710[`ytda`].
...
{url-base}#L407[`prettytable`] example:
