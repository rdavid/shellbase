...
{url-base}#L145[`chrono_sta`],
{url-base}#L153[`chrono_sto`],
{url-base}#L191[`cya`],
{url-base}#L198[`die`],
{url-base}#L207[`echo`],
{url-base}#L226[`file_exists`],
{url-base}#L240[`grbt`],
{url-base}#L252[`handle_pipefails`],
{url-base}#L258[`heic2jpg`],
{url-base}#L273[`inside`],
{url-base}#L280[`isempty`],
{url-base}#L297[`isfunc`],
{url-base}#L310[`isnumber`],
{url-base}#L318[`isreadable`],
{url-base}#L333[`issolid`],
{url-base}#L367[`iswritable`],
{url-base}#L392[`log`],
{url-base}#L401[`loge`],
{url-base}#L409[`logw`],
{url-base}#L418[`map_del`],
{url-base}#L441[`map_get`],
{url-base}#L460[`map_put`],
{url-base}#L473[`pdf2jpg`],
{url-base}#L483[`pdf2png`],
{url-base}#L507[`prettytable`],
{url-base}#L533[`prettyuptime`],
{url-base}#L556[`realdir`],
{url-base}#L565[`realpath`],
{url-base}#L578[`semver`],
{url-base}#L594[`timestamp`],
{url-base}#L614[`tolog`],
{url-base}#L620[`tologe`],
{url-base}#L627[`tolower`],
{url-base}#L645[`totsout`],
{url-base}#L651[`tsout`],
{url-base}#L659[`url_exists`],
{url-base}#L683[`user_exists`],
{url-base}#L699[`validate_cmd`],
{url-base}#L706[`validate_var`],
{url-base}#L713[`var_exists`],
{url-base}#L735[`ver_ge`],
{url-base}#L743[`vid2aud`],
{url-base}#L759[`yes_to_continue`],
{url-base}#L810[`ytda`].
...
{url-base}#L507[`prettytable`] example:
