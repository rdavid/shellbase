...
{url-base}#L152[`die`],
{url-base}#L161[`echo`],
{url-base}#L180[`file_exists`],
{url-base}#L194[`grbt`],
{url-base}#L206[`handle_pipefails`],
{url-base}#L212[`heic2jpg`],
{url-base}#L227[`inside`],
{url-base}#L235[`isempty`],
{url-base}#L249[`isfunc`],
{url-base}#L259[`isnumber`],
{url-base}#L267[`isreadable`],
{url-base}#L282[`issolid`],
{url-base}#L316[`iswritable`],
{url-base}#L341[`log`],
{url-base}#L350[`loge`],
{url-base}#L358[`logw`],
{url-base}#L367[`pdf2jpg`],
{url-base}#L377[`pdf2png`],
{url-base}#L401[`prettytable`],
{url-base}#L427[`prettyuptime`],
{url-base}#L450[`realdir`],
{url-base}#L459[`realpath`],
{url-base}#L472[`semver`],
{url-base}#L488[`timestamp`],
{url-base}#L508[`tolog`],
{url-base}#L514[`tologe`],
{url-base}#L521[`tolower`],
{url-base}#L539[`totsout`],
{url-base}#L545[`tsout`],
{url-base}#L553[`url_exists`],
{url-base}#L577[`user_exists`],
{url-base}#L593[`validate_cmd`],
{url-base}#L600[`validate_var`],
{url-base}#L607[`var_exists`],
{url-base}#L629[`ver_ge`],
{url-base}#L637[`vid2aud`],
{url-base}#L653[`yes_to_continue`],
{url-base}#L704[`ytda`].
...
{url-base}#L401[`prettytable`] example:
