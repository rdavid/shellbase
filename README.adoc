...
{url-base}#L144[`die`],
{url-base}#L153[`echo`],
{url-base}#L172[`file_exists`],
{url-base}#L186[`grbt`],
{url-base}#L198[`handle_pipefails`],
{url-base}#L204[`heic2jpg`],
{url-base}#L219[`inside`],
{url-base}#L227[`isempty`],
{url-base}#L241[`isfunc`],
{url-base}#L251[`isnumber`],
{url-base}#L259[`isreadable`],
{url-base}#L274[`issolid`],
{url-base}#L308[`iswritable`],
{url-base}#L333[`log`],
{url-base}#L342[`loge`],
{url-base}#L350[`logw`],
{url-base}#L359[`pdf2jpg`],
{url-base}#L369[`pdf2png`],
{url-base}#L393[`prettytable`],
{url-base}#L419[`prettyuptime`],
{url-base}#L442[`realdir`],
{url-base}#L451[`realpath`],
{url-base}#L464[`semver`],
{url-base}#L480[`timestamp`],
{url-base}#L500[`tolog`],
{url-base}#L506[`tologe`],
{url-base}#L513[`tolower`],
{url-base}#L531[`totsout`],
{url-base}#L537[`tsout`],
{url-base}#L545[`url_exists`],
{url-base}#L569[`user_exists`],
{url-base}#L585[`validate_cmd`],
{url-base}#L592[`validate_var`],
{url-base}#L599[`var_exists`],
{url-base}#L621[`ver_ge`],
{url-base}#L629[`vid2aud`],
{url-base}#L645[`yes_to_continue`],
{url-base}#L699[`ytda`].
