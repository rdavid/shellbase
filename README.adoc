...
{url-base}#L299[`inside`],
{url-base}#L306[`isempty`],
{url-base}#L330[`isfunc`],
{url-base}#L343[`isnumber`],
{url-base}#L351[`isreadable`],
{url-base}#L360[`issolid`],
{url-base}#L394[`iswritable`],
{url-base}#L408[`log`],
{url-base}#L417[`loge`],
{url-base}#L425[`logw`],
{url-base}#L434[`map_del`],
{url-base}#L454[`map_get`],
{url-base}#L476[`map_put`],
{url-base}#L488[`pdf2jpg`],
{url-base}#L498[`pdf2png`],
{url-base}#L522[`prettytable`],
{url-base}#L548[`prettyuptime`],
{url-base}#L571[`realdir`],
{url-base}#L580[`realpath`],
{url-base}#L593[`semver`],
{url-base}#L609[`timestamp`],
{url-base}#L629[`tolog`],
{url-base}#L635[`tologe`],
{url-base}#L642[`tolower`],
{url-base}#L660[`totsout`],
{url-base}#L666[`tsout`],
{url-base}#L674[`url_exists`],
{url-base}#L698[`user_exists`],
{url-base}#L714[`validate_cmd`],
{url-base}#L721[`validate_var`],
{url-base}#L728[`var_exists`],
{url-base}#L750[`ver_ge`],
{url-base}#L758[`vid2aud`],
{url-base}#L774[`yes_to_continue`],
{url-base}#L825[`ytda`].
...
{url-base}#L522[`prettytable`] example:
