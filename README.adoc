...
{url-base}#L181[`inside`],
{url-base}#L189[`isempty`],
{url-base}#L203[`isfunc`],
{url-base}#L211[`isreadable`],
{url-base}#L227[`issolid`],
{url-base}#L256[`iswritable`],
{url-base}#L281[`log`],
{url-base}#L290[`loge`],
{url-base}#L298[`logw`],
{url-base}#L307[`pdf2jpg`],
{url-base}#L316[`pdf2png`],
{url-base}#L339[`prettytable`],
{url-base}#L365[`prettyuptime`],
{url-base}#L388[`realdir`],
{url-base}#L397[`realpath`],
{url-base}#L409[`semver`],
{url-base}#L426[`timestamp`],
{url-base}#L446[`tolog`],
{url-base}#L452[`tologe`],
{url-base}#L458[`tolower`],
{url-base}#L463[`totsout`],
{url-base}#L469[`tsout`],
{url-base}#L477[`url_exists`],
{url-base}#L501[`user_exists`],
{url-base}#L517[`validate_cmd`],
{url-base}#L524[`validate_var`],
{url-base}#L531[`var_exists`],
{url-base}#L551[`ver_ge`],
{url-base}#L556[`vid2aud`],
{url-base}#L571[`yes_to_continue`],
{url-base}#L625[`ytda`].
