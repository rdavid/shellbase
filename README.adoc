...
{url-base}#L256[`grbt`],
{url-base}#L268[`handle_pipefails`],
{url-base}#L274[`heic2jpg`],
{url-base}#L289[`inside`],
{url-base}#L296[`isempty`],
{url-base}#L313[`isfunc`],
{url-base}#L326[`isnumber`],
{url-base}#L334[`isreadable`],
{url-base}#L349[`issolid`],
{url-base}#L383[`iswritable`],
{url-base}#L408[`log`],
{url-base}#L417[`loge`],
{url-base}#L425[`logw`],
{url-base}#L434[`map_del`],
{url-base}#L454[`map_get`],
{url-base}#L472[`map_put`],
{url-base}#L484[`pdf2jpg`],
{url-base}#L494[`pdf2png`],
{url-base}#L518[`prettytable`],
{url-base}#L544[`prettyuptime`],
{url-base}#L567[`realdir`],
{url-base}#L576[`realpath`],
{url-base}#L589[`semver`],
{url-base}#L605[`timestamp`],
{url-base}#L625[`tolog`],
{url-base}#L631[`tologe`],
{url-base}#L638[`tolower`],
{url-base}#L656[`totsout`],
{url-base}#L662[`tsout`],
{url-base}#L670[`url_exists`],
{url-base}#L694[`user_exists`],
{url-base}#L710[`validate_cmd`],
{url-base}#L717[`validate_var`],
{url-base}#L724[`var_exists`],
{url-base}#L746[`ver_ge`],
{url-base}#L754[`vid2aud`],
{url-base}#L770[`yes_to_continue`],
{url-base}#L821[`ytda`].
...
{url-base}#L518[`prettytable`] example:
