...
{url-base}#L472[`tolower`],
{url-base}#L490[`totsout`],
{url-base}#L496[`tsout`],
{url-base}#L504[`url_exists`],
{url-base}#L528[`user_exists`],
{url-base}#L544[`validate_cmd`],
{url-base}#L551[`validate_var`],
{url-base}#L558[`var_exists`],
{url-base}#L580[`ver_ge`],
{url-base}#L588[`vid2aud`],
{url-base}#L604[`yes_to_continue`],
{url-base}#L658[`ytda`].
