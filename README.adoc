...
{url-base}#L236[`isempty`],
{url-base}#L250[`isfunc`],
{url-base}#L260[`isnumber`],
{url-base}#L268[`isreadable`],
{url-base}#L283[`issolid`],
{url-base}#L329[`iswritable`],
{url-base}#L354[`log`],
{url-base}#L363[`loge`],
{url-base}#L371[`logw`],
{url-base}#L380[`pdf2jpg`],
{url-base}#L390[`pdf2png`],
{url-base}#L414[`prettytable`],
{url-base}#L440[`prettyuptime`],
{url-base}#L463[`realdir`],
{url-base}#L472[`realpath`],
{url-base}#L485[`semver`],
{url-base}#L501[`timestamp`],
{url-base}#L521[`tolog`],
{url-base}#L527[`tologe`],
{url-base}#L534[`tolower`],
{url-base}#L552[`totsout`],
{url-base}#L558[`tsout`],
{url-base}#L566[`url_exists`],
{url-base}#L590[`user_exists`],
{url-base}#L606[`validate_cmd`],
{url-base}#L613[`validate_var`],
{url-base}#L620[`var_exists`],
{url-base}#L642[`ver_ge`],
{url-base}#L650[`vid2aud`],
{url-base}#L666[`yes_to_continue`],
{url-base}#L717[`ytda`].
...
{url-base}#L414[`prettytable`] example:
