...
{url-base}#L221[`isnumber`],
{url-base}#L229[`isreadable`],
{url-base}#L244[`issolid`],
{url-base}#L278[`iswritable`],
{url-base}#L303[`log`],
{url-base}#L312[`loge`],
{url-base}#L320[`logw`],
{url-base}#L329[`pdf2jpg`],
{url-base}#L339[`pdf2png`],
{url-base}#L363[`prettytable`],
{url-base}#L389[`prettyuptime`],
{url-base}#L412[`realdir`],
{url-base}#L421[`realpath`],
{url-base}#L433[`semver`],
{url-base}#L449[`timestamp`],
{url-base}#L469[`tolog`],
{url-base}#L475[`tologe`],
{url-base}#L482[`tolower`],
{url-base}#L500[`totsout`],
{url-base}#L506[`tsout`],
{url-base}#L514[`url_exists`],
{url-base}#L538[`user_exists`],
{url-base}#L554[`validate_cmd`],
{url-base}#L561[`validate_var`],
{url-base}#L568[`var_exists`],
{url-base}#L590[`ver_ge`],
{url-base}#L598[`vid2aud`],
{url-base}#L614[`yes_to_continue`],
{url-base}#L668[`ytda`].
...
{url-base}#L363[`prettytable`] example:
