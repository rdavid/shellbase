...
It's POSIX-compliant (`Portable Operating System Interface for uniX`),
...
All functions without the `base_` prefix are public; clients may use them.
...
{url-base}#L684[`rsyncx`],
{url-base}#L739[`semver`],
{url-base}#L757[`should_continue`],
{url-base}#L813[`timestamp`],
{url-base}#L833[`tolog`],
{url-base}#L839[`tologe`],
{url-base}#L846[`tolower`],
{url-base}#L864[`totsout`],
{url-base}#L870[`tsout`],
{url-base}#L878[`url_exists`],
{url-base}#L902[`user_exists`],
{url-base}#L918[`validate_cmd`],
{url-base}#L925[`validate_var`],
{url-base}#L932[`var_exists`],
{url-base}#L968[`ver_ge`],
{url-base}#L976[`vid2aud`],
{url-base}#L990[`ytda`].

Global variables have the `BASE_` prefix; clients may use them.
Clients should place temporary files under `$BASE_WIP`.
All functions starting with the `base_` prefix are internal; clients should not
use them.
