...
{url-base}#L114[`die`],
{url-base}#L121[`echo`],
{url-base}#L139[`file_exists`],
{url-base}#L154[`grbt`],
{url-base}#L164[`heic2jpg`],
{url-base}#L178[`inside`],
{url-base}#L187[`isempty`],
{url-base}#L200[`isfunc`],
{url-base}#L208[`isreadable`],
{url-base}#L224[`issolid`],
{url-base}#L253[`iswritable`],
{url-base}#L278[`log`],
{url-base}#L287[`loge`],
{url-base}#L295[`logw`],
{url-base}#L304[`pdf2jpg`],
{url-base}#L313[`pdf2png`],
{url-base}#L336[`prettytable`],
{url-base}#L361[`prettyuptime`],
{url-base}#L379[`realdir`],
{url-base}#L388[`realpath`],
{url-base}#L400[`semver`],
{url-base}#L417[`timestamp`],
{url-base}#L437[`tolog`],
{url-base}#L443[`tologe`],
{url-base}#L449[`tolower`],
{url-base}#L454[`totsout`],
{url-base}#L460[`tsout`],
{url-base}#L469[`url_exists`],
{url-base}#L494[`user_exists`],
{url-base}#L510[`validate_cmd`],
{url-base}#L517[`validate_var`],
{url-base}#L524[`var_exists`],
{url-base}#L545[`ver_ge`],
{url-base}#L550[`vid2aud`],
{url-base}#L565[`yes_to_continue`],
{url-base}#L619[`ytda`].
