...
{url-base}#L168[`chrono_sta`],
{url-base}#L179[`chrono_sto`],
{url-base}#L193[`cmd_exists`],
{url-base}#L227[`cya`],
{url-base}#L237[`die`],
{url-base}#L247[`dng2jpg`],
{url-base}#L253[`echo`],
{url-base}#L275[`ellipsize`],
{url-base}#L309[`file_exists`],
{url-base}#L318[`gitlog`],
{url-base}#L342[`grbt`],
{url-base}#L354[`handle_pipefails`],
{url-base}#L360[`heic2jpg`],
{url-base}#L373[`inside`],
{url-base}#L380[`isempty`],
{url-base}#L404[`isfunc`],
{url-base}#L417[`isnumber`],
{url-base}#L425[`isreadable`],
{url-base}#L434[`isroot`],
{url-base}#L446[`issolid`],
{url-base}#L480[`iswritable`],
{url-base}#L494[`log`],
{url-base}#L503[`loge`],
{url-base}#L511[`logw`],
{url-base}#L520[`map_del`],
{url-base}#L540[`map_get`],
{url-base}#L562[`map_put`],
{url-base}#L574[`nmea2gpx`],
{url-base}#L593[`pdf2jpg`],
{url-base}#L598[`pdf2png`],
{url-base}#L617[`prettytable`],
{url-base}#L643[`prettyuptime`],
{url-base}#L666[`realdir`],
{url-base}#L675[`realpath`],
{url-base}#L685[`retry`],
{url-base}#L707[`rsyncx`],
{url-base}#L762[`semver`],
{url-base}#L780[`should_continue`],
{url-base}#L838[`timestamp`],
{url-base}#L858[`tolog`],
{url-base}#L864[`tologe`],
{url-base}#L871[`tolower`],
{url-base}#L889[`totsout`],
{url-base}#L895[`tsout`],
{url-base}#L903[`url_exists`],
{url-base}#L927[`user_exists`],
{url-base}#L943[`validate_cmd`],
{url-base}#L950[`validate_var`],
{url-base}#L957[`var_exists`],
{url-base}#L992[`ver_ge`],
{url-base}#L1000[`vid2aud`],
{url-base}#L1014[`ytda`].
