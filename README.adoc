...
{url-base}#L297[`inside`],
{url-base}#L304[`isempty`],
{url-base}#L328[`isfunc`],
{url-base}#L341[`isnumber`],
{url-base}#L349[`isreadable`],
{url-base}#L358[`issolid`],
{url-base}#L392[`iswritable`],
{url-base}#L406[`log`],
{url-base}#L415[`loge`],
{url-base}#L423[`logw`],
{url-base}#L432[`map_del`],
{url-base}#L452[`map_get`],
{url-base}#L474[`map_put`],
{url-base}#L486[`pdf2jpg`],
{url-base}#L496[`pdf2png`],
{url-base}#L520[`prettytable`],
{url-base}#L546[`prettyuptime`],
{url-base}#L569[`realdir`],
{url-base}#L578[`realpath`],
{url-base}#L591[`semver`],
{url-base}#L609[`should_continue`],
{url-base}#L665[`timestamp`],
{url-base}#L685[`tolog`],
{url-base}#L691[`tologe`],
{url-base}#L698[`tolower`],
{url-base}#L716[`totsout`],
{url-base}#L722[`tsout`],
{url-base}#L730[`url_exists`],
{url-base}#L754[`user_exists`],
{url-base}#L770[`validate_cmd`],
{url-base}#L777[`validate_var`],
{url-base}#L784[`var_exists`],
{url-base}#L806[`ver_ge`],
{url-base}#L814[`vid2aud`],
{url-base}#L830[`yes_to_continue`],
{url-base}#L837[`ytda`].
...
{url-base}#L520[`prettytable`] example:
