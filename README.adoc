...
{url-base}#L317[`iswritable`],
{url-base}#L342[`log`],
{url-base}#L351[`loge`],
{url-base}#L359[`logw`],
{url-base}#L368[`pdf2jpg`],
{url-base}#L378[`pdf2png`],
{url-base}#L402[`prettytable`],
{url-base}#L428[`prettyuptime`],
{url-base}#L451[`realdir`],
{url-base}#L460[`realpath`],
{url-base}#L473[`semver`],
{url-base}#L489[`timestamp`],
{url-base}#L509[`tolog`],
{url-base}#L515[`tologe`],
{url-base}#L522[`tolower`],
{url-base}#L540[`totsout`],
{url-base}#L546[`tsout`],
{url-base}#L554[`url_exists`],
{url-base}#L578[`user_exists`],
{url-base}#L594[`validate_cmd`],
{url-base}#L601[`validate_var`],
{url-base}#L608[`var_exists`],
{url-base}#L630[`ver_ge`],
{url-base}#L638[`vid2aud`],
{url-base}#L654[`yes_to_continue`],
{url-base}#L705[`ytda`].
...
{url-base}#L402[`prettytable`] example:
