...
{url-base}#L220[`die`],
{url-base}#L231[`echo`],
{url-base}#L253[`ellipsize`],
{url-base}#L271[`file_exists`],
{url-base}#L279[`grbt`],
{url-base}#L291[`handle_pipefails`],
{url-base}#L297[`heic2jpg`],
{url-base}#L321[`inside`],
{url-base}#L328[`isempty`],
{url-base}#L352[`isfunc`],
{url-base}#L365[`isnumber`],
{url-base}#L373[`isreadable`],
{url-base}#L382[`issolid`],
{url-base}#L416[`iswritable`],
{url-base}#L430[`log`],
{url-base}#L439[`loge`],
{url-base}#L447[`logw`],
{url-base}#L456[`map_del`],
{url-base}#L476[`map_get`],
{url-base}#L498[`map_put`],
{url-base}#L510[`pdf2jpg`],
{url-base}#L520[`pdf2png`],
{url-base}#L544[`prettytable`],
{url-base}#L570[`prettyuptime`],
...
{url-base}#L544[`prettytable`] example:
