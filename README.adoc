...
{url-base}#L156[`grbt`],
{url-base}#L167[`heic2jpg`],
{url-base}#L182[`inside`],
{url-base}#L190[`isempty`],
{url-base}#L204[`isfunc`],
{url-base}#L212[`isreadable`],
{url-base}#L227[`issolid`],
{url-base}#L261[`iswritable`],
{url-base}#L286[`log`],
{url-base}#L295[`loge`],
{url-base}#L303[`logw`],
{url-base}#L312[`pdf2jpg`],
{url-base}#L322[`pdf2png`],
{url-base}#L346[`prettytable`],
{url-base}#L372[`prettyuptime`],
{url-base}#L395[`realdir`],
{url-base}#L404[`realpath`],
{url-base}#L416[`semver`],
{url-base}#L432[`timestamp`],
{url-base}#L452[`tolog`],
{url-base}#L458[`tologe`],
{url-base}#L464[`tolower`],
{url-base}#L469[`totsout`],
{url-base}#L475[`tsout`],
{url-base}#L483[`url_exists`],
{url-base}#L507[`user_exists`],
{url-base}#L523[`validate_cmd`],
{url-base}#L530[`validate_var`],
{url-base}#L537[`var_exists`],
{url-base}#L557[`ver_ge`],
{url-base}#L562[`vid2aud`],
{url-base}#L578[`yes_to_continue`],
{url-base}#L632[`ytda`].
...
{url-base}#L346[`prettytable`] example:
