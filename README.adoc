...
{url-base}#L101[`beroot`],
{url-base}#L106[`beuser`],
{url-base}#L117[`bomb`],
{url-base}#L123[`cheat`],
...
{url-base}#L150[`die`],
{url-base}#L159[`echo`],
{url-base}#L178[`file_exists`],
{url-base}#L192[`grbt`],
{url-base}#L204[`handle_pipefails`],
{url-base}#L210[`heic2jpg`],
{url-base}#L225[`inside`],
{url-base}#L233[`isempty`],
{url-base}#L247[`isfunc`],
{url-base}#L257[`isnumber`],
{url-base}#L265[`isreadable`],
{url-base}#L280[`issolid`],
{url-base}#L314[`iswritable`],
{url-base}#L339[`log`],
{url-base}#L348[`loge`],
{url-base}#L356[`logw`],
{url-base}#L365[`pdf2jpg`],
{url-base}#L375[`pdf2png`],
{url-base}#L399[`prettytable`],
{url-base}#L425[`prettyuptime`],
{url-base}#L448[`realdir`],
{url-base}#L457[`realpath`],
{url-base}#L470[`semver`],
{url-base}#L486[`timestamp`],
{url-base}#L506[`tolog`],
{url-base}#L512[`tologe`],
{url-base}#L519[`tolower`],
{url-base}#L537[`totsout`],
{url-base}#L543[`tsout`],
{url-base}#L551[`url_exists`],
{url-base}#L575[`user_exists`],
{url-base}#L591[`validate_cmd`],
{url-base}#L598[`validate_var`],
{url-base}#L605[`var_exists`],
{url-base}#L627[`ver_ge`],
{url-base}#L635[`vid2aud`],
{url-base}#L651[`yes_to_continue`],
{url-base}#L702[`ytda`].
...
{url-base}#L393[`prettytable`] example:
