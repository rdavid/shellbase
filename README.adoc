...
{url-base}#L232[`cya`],
{url-base}#L243[`die`],
{url-base}#L251[`dng2jpg`],
{url-base}#L257[`echo`],
{url-base}#L279[`ellipsize`],
{url-base}#L313[`file_exists`],
{url-base}#L322[`gitlog`],
{url-base}#L346[`grbt`],
{url-base}#L358[`handle_pipefails`],
{url-base}#L364[`heic2jpg`],
{url-base}#L377[`inside`],
{url-base}#L384[`isempty`],
{url-base}#L408[`isfunc`],
{url-base}#L421[`isnumber`],
{url-base}#L429[`isreadable`],
{url-base}#L438[`isroot`],
{url-base}#L450[`issolid`],
{url-base}#L484[`iswritable`],
{url-base}#L498[`log`],
{url-base}#L507[`loge`],
{url-base}#L515[`logw`],
{url-base}#L524[`map_del`],
{url-base}#L544[`map_get`],
{url-base}#L566[`map_put`],
{url-base}#L578[`nmea2gpx`],
{url-base}#L597[`pdf2jpg`],
{url-base}#L602[`pdf2png`],
{url-base}#L621[`prettytable`],
{url-base}#L647[`prettyuptime`],
{url-base}#L670[`realdir`],
{url-base}#L679[`realpath`],
{url-base}#L689[`retry`],
{url-base}#L711[`rsyncx`],
{url-base}#L766[`semver`],
{url-base}#L784[`should_continue`],
{url-base}#L842[`timestamp`],
{url-base}#L862[`tolog`],
{url-base}#L868[`tologe`],
{url-base}#L875[`tolower`],
{url-base}#L893[`totsout`],
{url-base}#L899[`tsout`],
{url-base}#L907[`url_exists`],
{url-base}#L931[`user_exists`],
{url-base}#L947[`validate_cmd`],
{url-base}#L954[`validate_var`],
{url-base}#L961[`var_exists`],
{url-base}#L996[`ver_ge`],
{url-base}#L1004[`vid2aud`],
{url-base}#L1018[`ytda`].
...
{url-base}#L621[`prettytable`] example:
