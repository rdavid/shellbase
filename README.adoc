...
{url-base}#L357[`heic2jpg`],
{url-base}#L370[`inside`],
{url-base}#L377[`isempty`],
{url-base}#L401[`isfunc`],
{url-base}#L414[`isnumber`],
{url-base}#L422[`isreadable`],
{url-base}#L431[`isroot`],
{url-base}#L443[`issolid`],
{url-base}#L477[`iswritable`],
{url-base}#L491[`log`],
{url-base}#L500[`loge`],
{url-base}#L508[`logw`],
{url-base}#L517[`map_del`],
{url-base}#L537[`map_get`],
{url-base}#L559[`map_put`],
{url-base}#L573[`nmea2gpx`],
{url-base}#L589[`pdf2jpg`],
{url-base}#L594[`pdf2png`],
{url-base}#L613[`prettytable`],
{url-base}#L639[`prettyuptime`],
{url-base}#L662[`realdir`],
{url-base}#L671[`realpath`],
{url-base}#L681[`retry`],
{url-base}#L706[`semver`],
{url-base}#L724[`should_continue`],
{url-base}#L782[`timestamp`],
{url-base}#L802[`tolog`],
{url-base}#L808[`tologe`],
{url-base}#L815[`tolower`],
{url-base}#L833[`totsout`],
{url-base}#L839[`tsout`],
{url-base}#L847[`url_exists`],
{url-base}#L871[`user_exists`],
{url-base}#L887[`validate_cmd`],
{url-base}#L894[`validate_var`],
{url-base}#L901[`var_exists`],
{url-base}#L936[`ver_ge`],
{url-base}#L944[`vid2aud`],
{url-base}#L958[`ytda`].
...
{url-base}#L613[`prettytable`] example:
