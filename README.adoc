...
{url-base}#L453[`map_put`],
{url-base}#L465[`pdf2jpg`],
{url-base}#L475[`pdf2png`],
{url-base}#L499[`prettytable`],
{url-base}#L525[`prettyuptime`],
{url-base}#L548[`realdir`],
{url-base}#L557[`realpath`],
{url-base}#L570[`semver`],
{url-base}#L586[`timestamp`],
{url-base}#L606[`tolog`],
{url-base}#L612[`tologe`],
{url-base}#L619[`tolower`],
{url-base}#L637[`totsout`],
{url-base}#L643[`tsout`],
{url-base}#L651[`url_exists`],
{url-base}#L675[`user_exists`],
{url-base}#L691[`validate_cmd`],
{url-base}#L698[`validate_var`],
{url-base}#L705[`var_exists`],
{url-base}#L727[`ver_ge`],
{url-base}#L735[`vid2aud`],
{url-base}#L751[`yes_to_continue`],
{url-base}#L802[`ytda`].
...
{url-base}#L499[`prettytable`] example:
