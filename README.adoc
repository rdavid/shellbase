...
{url-base}#L301[`inside`],
{url-base}#L308[`isempty`],
{url-base}#L332[`isfunc`],
{url-base}#L345[`isnumber`],
{url-base}#L353[`isreadable`],
{url-base}#L362[`issolid`],
{url-base}#L396[`iswritable`],
{url-base}#L410[`log`],
{url-base}#L419[`loge`],
{url-base}#L427[`logw`],
{url-base}#L436[`map_del`],
{url-base}#L456[`map_get`],
{url-base}#L478[`map_put`],
{url-base}#L490[`pdf2jpg`],
{url-base}#L500[`pdf2png`],
{url-base}#L524[`prettytable`],
{url-base}#L550[`prettyuptime`],
{url-base}#L573[`realdir`],
{url-base}#L582[`realpath`],
{url-base}#L595[`semver`],
{url-base}#L611[`timestamp`],
{url-base}#L631[`tolog`],
{url-base}#L637[`tologe`],
{url-base}#L644[`tolower`],
{url-base}#L662[`totsout`],
{url-base}#L668[`tsout`],
{url-base}#L676[`url_exists`],
{url-base}#L700[`user_exists`],
{url-base}#L716[`validate_cmd`],
{url-base}#L723[`validate_var`],
{url-base}#L730[`var_exists`],
{url-base}#L752[`ver_ge`],
{url-base}#L760[`vid2aud`],
{url-base}#L776[`yes_to_continue`],
{url-base}#L827[`ytda`].
...
{url-base}#L524[`prettytable`] example:
