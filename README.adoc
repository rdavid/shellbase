...
{url-base}#L390[`gitlog`],
{url-base}#L416[`grbt`],
{url-base}#L433[`handle_pipefails`],
{url-base}#L440[`heic2jpg`],
{url-base}#L453[`inside`],
{url-base}#L460[`isempty`],
{url-base}#L484[`isfunc`],
{url-base}#L497[`isnumber`],
{url-base}#L505[`isreadable`],
{url-base}#L514[`isroot`],
{url-base}#L526[`issolid`],
{url-base}#L560[`iswritable`],
{url-base}#L573[`log`],
{url-base}#L582[`loge`],
{url-base}#L590[`logw`],
{url-base}#L599[`map_del`],
{url-base}#L619[`map_get`],
{url-base}#L641[`map_put`],
{url-base}#L658[`nmea2gpx`],
{url-base}#L673[`pdf2jpg`],
{url-base}#L678[`pdf2png`],
{url-base}#L699[`prettytable`],
{url-base}#L719[`prettyuptime`],
{url-base}#L742[`realdir`],
{url-base}#L751[`realpath`],
{url-base}#L762[`retry`],
{url-base}#L800[`rev`],
{url-base}#L814[`semver`],
{url-base}#L832[`should_continue`],
{url-base}#L890[`timestamp`],
{url-base}#L910[`tolog`],
{url-base}#L916[`tologe`],
{url-base}#L923[`tolower`],
{url-base}#L941[`totsout`],
{url-base}#L947[`tsout`],
{url-base}#L956[`url_exists`],
{url-base}#L985[`user_exists`],
{url-base}#L1004[`validate_cmd`],
{url-base}#L1011[`validate_var`],
{url-base}#L1029[`var_exists`],
{url-base}#L1069[`ver_ge`],
{url-base}#L1080[`vid2aud`],
{url-base}#L1101[`ytda`].
...
{url-base}#L573[`log`] for information,
{url-base}#L582[`loge`] for errors, and
{url-base}#L590[`logw`] for warnings.
...
{url-base}#L699[`prettytable`] example:
