...
{url-base}#L153[`die`],
{url-base}#L162[`echo`],
{url-base}#L181[`file_exists`],
{url-base}#L195[`grbt`],
{url-base}#L207[`handle_pipefails`],
{url-base}#L213[`heic2jpg`],
{url-base}#L228[`inside`],
{url-base}#L235[`isempty`],
{url-base}#L252[`isfunc`],
{url-base}#L265[`isnumber`],
{url-base}#L273[`isreadable`],
{url-base}#L288[`issolid`],
{url-base}#L322[`iswritable`],
{url-base}#L347[`log`],
{url-base}#L356[`loge`],
{url-base}#L364[`logw`],
{url-base}#L373[`map_del`],
{url-base}#L396[`map_get`],
{url-base}#L415[`map_put`],
{url-base}#L428[`pdf2jpg`],
{url-base}#L438[`pdf2png`],
{url-base}#L462[`prettytable`],
{url-base}#L488[`prettyuptime`],
{url-base}#L511[`realdir`],
{url-base}#L520[`realpath`],
{url-base}#L533[`semver`],
{url-base}#L549[`timestamp`],
{url-base}#L569[`tolog`],
{url-base}#L575[`tologe`],
{url-base}#L582[`tolower`],
{url-base}#L600[`totsout`],
{url-base}#L606[`tsout`],
{url-base}#L614[`url_exists`],
{url-base}#L638[`user_exists`],
{url-base}#L654[`validate_cmd`],
{url-base}#L661[`validate_var`],
{url-base}#L668[`var_exists`],
{url-base}#L690[`ver_ge`],
{url-base}#L698[`vid2aud`],
{url-base}#L714[`yes_to_continue`],
{url-base}#L765[`ytda`].
...
{url-base}#L462[`prettytable`] example:
